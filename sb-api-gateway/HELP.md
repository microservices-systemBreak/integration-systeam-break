...
* The original package name 'com.systembreak.sb-api-gateway' is invalid and this project uses 'com.systembreak.sb_api_gateway' instead.
...
* [OAuth2 Resource Server](https://docs.spring.io/spring-boot/3.4.12/reference/web/spring-security.html#web.security.oauth2.server)
